  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[60vh] text-center p-6 space-y-4">
      ...
      <div className="space-y-1 max-w-sm">
        <h1 className="text-2xl font-bold text-plum-900">Daily Mood Check-in</h1>
        <p className="text-xs text-plum-500">
          Express your feelings, energy level, and small signals to stay emotionally synchronized.
        </p>
      </div>
